...
/**
 * A {@code UrlLookupsSupportDirContext} is ...
 *
 * @author Guillaume Sauthier
 */
public class UrlLookupsSupportDirContext extends UrlLookupsSupportContext<DirContext> implements DirContext {

    public UrlLookupsSupportDirContext(DirContext delegate) {
        super(delegate);
    }
